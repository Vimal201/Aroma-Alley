        ...
        <div class="row">
            <div class="box">
				...
				<h2 class="text-center">Welcome <?php echo $fname; echo " ";echo $lname; ?> - <a href="logout.php">Logout</a></h2>
                    <hr>
                    <h2 class="intro-text text-center">AROMA ALLEY
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Take the edge off with a French hot cup of coffee made with Irish whiskey and Irish .</p>
